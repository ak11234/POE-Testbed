...
task main()
{
	int brightest; //declare var biggest

	while (1==1)

	{

		brightest = 0; //init var biggest

		while (SensorValue(bumpSwitch)==0) //while bumpswitch returns 0

		{

			if (SensorValue(lightSensor)>brightest) //if the potentiomenter value is larger than biggest

			{

				brightest=SensorValue(lightSensor); //set biggest to potentiometer
